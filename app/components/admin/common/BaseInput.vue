  ...
  <div class="flex flex-col gap-2">
    ...
    <div class="relative w-full">
      <input
        ...
        "
        :class="[
          'relative w-full font-sans text-dark dark:text-light bg-transparent h-12 px-4 py-2 rounded-lg border transition-colors focus:outline-none',
          error ? 'border-red-500 focus:border-red-500' : '',
          !error && validated ? 'border-green-500 focus:border-green-500' : '',
          !error && !validated
